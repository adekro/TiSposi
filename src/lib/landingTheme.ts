...
export const LANDING_THEME_PRESETS: Record<LandingThemePreset, LandingThemeView> = {
  gold: {
    ...
    pagePattern:
      "radial-gradient(circle at 10% 12%, rgba(201,167,108,0.12) 0 2px, transparent 2px 100%), radial-gradient(circle at 86% 84%, rgba(201,160,176,0.1) 0 2px, transparent 2px 100%), repeating-linear-gradient(45deg, rgba(201,167,108,0.05) 0 1px, transparent 1px 26px)",
