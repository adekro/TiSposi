  ...
  try {
    ...
    const payload: PublicGalleryResponse = {
      event: {
        ...
        showFlightInfo: event.show_flight_info,
        flightAirport: event.flight_airport,
        flightShuttle: event.flight_shuttle,
        flightSchedule: event.flight_schedule,
        showParkingInfo: event.show_parking_info,
        parkingInfo: event.parking_info,
        showAccommodationInfo: event.show_accommodation_info,
        accommodationHotel: event.accommodation_hotel,
        accommodationFullBoard: event.accommodation_full_board,
        accommodationAgreements: event.accommodation_agreements,
